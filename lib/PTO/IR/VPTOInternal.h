...
// Batch1: 跨文件共享函数声明(定义分布在 VPTO/VPTOMte/VPTOMteAsm/VPTODma/VPTOCubeBridge)
...
template <typename CopyOp> LogicalResult verifyCopyCbufToUbufLikeOp(CopyOp op);
template <typename CopyOp> LogicalResult verifyCopyGmToUbufOp(CopyOp op, bool expectSourceGM);
