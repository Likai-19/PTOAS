...
void LaunchPack_unpack_roundtrip_f8e4m3_kernel(uint8_t *src, uint8_t *dst, void *stream);
...
int main() {
  ...
  LaunchPack_unpack_roundtrip_f8e4m3_kernel(srcDevice, dstDevice, stream);
